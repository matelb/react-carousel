...
var Carousel = function (_a) {
    ...
    return (react_1.default.createElement("div", { className: "custom-carousel", style: { width: cardWith, height: cardHeight } },
        !hideArrows && (react_1.default.createElement("div", { className: "arrow-container custom-left-arrow", onClick: backClick, style: __assign({}, arrowLeftProps) },
            react_1.default.createElement(ArrowBackIosRounded_1.default, { fontSize: "large" }))),
        react_1.default.createElement(react_spring_1.animated.div, { className: classes.container + " custom-carousel-container" }, props.map(function (_a, i) {
            var x = _a.x, display = _a.display, sc = _a.sc;
            console.log({ display: display });
            var image = images[i];
            return (react_1.default.createElement(react_spring_1.animated.div, __assign({ key: i }, bindDrag(), { className: classes.card + " custom-carousel-item", style: {
        ...
        !hideArrows && (react_1.default.createElement("div", { className: "arrow-container custom-right-arrow", style: __assign({}, arrowRightProps) },
