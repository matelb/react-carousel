...
var defaultAnimationConfig = { mass: 5, tension: 150, friction: 40 };
var Carousel = function (_a) {
    var auto = _a.auto, width = _a.width, height = _a.height, imageProps = _a.imageProps, cardProps = _a.cardProps, containerProps = _a.containerProps, arrowLeftProps = _a.arrowLeftProps, arrowRightProps = _a.arrowRightProps, onForward = _a.onForward, onBack = _a.onBack, images = _a.images, hideArrows = _a.hideArrows, autoTime = _a.autoTime, animationConfig = _a.animationConfig, hideImageDescription = _a.hideImageDescription, imageDescriptionProps = _a.imageDescriptionProps;
    ...
    var useStyles = styles_1.makeStyles(function (theme) {
        return styles_1.createStyles({
            container: __assign(__assign({}, containerProps), { width: (containerProps === null || containerProps === void 0 ? void 0 : containerProps.width) || cardWith, height: (containerProps === null || containerProps === void 0 ? void 0 : containerProps.height) || cardHeight, backgroundColor: (containerProps === null || containerProps === void 0 ? void 0 : containerProps.backgroundColor) || "rgba(0,0,0,0.1)" }),
            card: __assign(__assign({}, cardProps), { width: (cardProps === null || cardProps === void 0 ? void 0 : cardProps.width) || cardWith, height: (cardProps === null || cardProps === void 0 ? void 0 : cardProps.height) || cardHeight, backgroundColor: (cardProps === null || cardProps === void 0 ? void 0 : cardProps.backgroundColor) || defaultColor }),
        });
    });
    ...
    return (react_1.default.createElement("div", { className: mainClasses.customCarousel, style: { width: cardWith, height: cardHeight } },
        ...
        react_1.default.createElement(react_spring_1.animated.div, { className: mainClasses.customCarouselContainer + " " + classes.container }, props.map(function (_a, i) {
            ...
            return (react_1.default.createElement(react_spring_1.animated.div, __assign({ key: i }, bindDrag(), { className: mainClasses.customCarouselItem + " " + classes.card, style: {
                ...
                !hideImageDescription && image.description && (react_1.default.createElement("div", { className: mainClasses.customImageDescriptionContainer, style: imageDescriptionProps === null || imageDescriptionProps === void 0 ? void 0 : imageDescriptionProps.container },
                    ((_b = image.description) === null || _b === void 0 ? void 0 : _b.title) && (react_1.default.createElement("span", { className: mainClasses.customImageDescriptionTitle, style: imageDescriptionProps === null || imageDescriptionProps === void 0 ? void 0 : imageDescriptionProps.title }, (_c = image.description) === null || _c === void 0 ? void 0 : _c.title)),
                    ((_d = image.description) === null || _d === void 0 ? void 0 : _d.text) && (react_1.default.createElement("span", { className: mainClasses.customImageDescriptionDescription, style: imageDescriptionProps === null || imageDescriptionProps === void 0 ? void 0 : imageDescriptionProps.text }, (_e = image.description) === null || _e === void 0 ? void 0 : _e.text)))),
